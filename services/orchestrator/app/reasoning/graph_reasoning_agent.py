...
# NodeCategory is defined locally — the rag_services graph_models module
# does not expose this enum, and importing via sys.path was a hack.
class NodeCategory(str, Enum):
    """Categories of graph nodes used for reasoning routing."""
    MON_HOC = "MON_HOC"
    QUY_DINH = "QUY_DINH"
    DIEU_KIEN = "DIEU_KIEN"
    KHOA = "KHOA"
