...
""")
    ...
    def should_use_ircot(self, complexity: str, complexity_score: float) -> bool:
        ...
        if self.mode == IRCoTMode.DISABLED: return False
        if self.mode == IRCoTMode.FORCED: return True
        return (complexity == "complex" or complexity_score >= self.complexity_threshold)
