...
Usage:
    from app.knowledge_graph.domain.llamaindex_retriever import LlamaIndexHybridRetriever
...
class PortBasedVectorRetriever(BaseRetriever):
    ...
    async def _aretrieve(self, query_bundle: QueryBundle) -> List[NodeWithScore]:
        ...
        """
        from app.knowledge_graph.domain.models import SearchQuery, SearchMode
