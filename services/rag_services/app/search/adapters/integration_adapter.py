...
from app.search.schemas import SearchRequest, SearchHit
from app.shared.container.container import get_search_service
from app.knowledge_graph.domain.models import SearchQuery, SearchMode, SearchFilters, DocumentLanguage
from app.search.adapters.mappers.search_mappers import SearchMapper
...
class IntegrationSearchAdapter:
    ...
    def _run_async_search(self, domain_query):
        ...
        try:
            ...
            from app.knowledge_graph.domain.models import SearchResponse
