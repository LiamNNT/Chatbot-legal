...
class LegalIngestionService:
    ...
    def _get_graph_adapter(self):
        ...
        if self._graph_adapter is None:
            try:
                from app.knowledge_graph.adapters.neo4j_adapter import Neo4jGraphAdapter
    ...
    async def index_to_neo4j(
        ...
        try:
            from app.knowledge_graph.domain.graph_models import GraphNode, GraphRelationship, NodeCategory, RelationshipType
