"""
Shared RAG domain models — canonical definitions.

Covers search queries, results, document chunks, and associated metadata
used by both rag_services and internal.
"""
